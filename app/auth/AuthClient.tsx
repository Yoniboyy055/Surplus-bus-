...
export default function AuthClient() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    // User will be redirected to Google, no need to set success state
  };
  ...
  return (
    <section className="space-y-4">
      ...
      <button
        ...
        className="w-full inline-flex items-center justify-center gap-3 font-semibold rounded-full transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-quantum-950 focus:ring-cyan-500 disabled:opacity-50 disabled:cursor-not-allowed bg-white text-quantum-950 hover:bg-quantum-100 border border-quantum-700 px-4 py-3 text-base active:scale-95"
      >
        {status === "loading" ? (
          <>
